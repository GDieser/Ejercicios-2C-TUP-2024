...
/*
Un individuo acaba de obtener su álbum de figuritas de DragonCube. Se trata de un libro cuyas
páginas cuentan con espacios en blanco designados para pegar 50 figuritas.

Estos espacios en blanco están numerados y cada uno de ellos está reservado para una figurita
en particular, identificada con el mismo número. Luego de obtener el álbum, el coleccionista comienza
a comprar paquetes de figuritas que contienen, cada uno, 5 unidades. Los paquetes vienen identificados
con un número natural como código.
...
No hay límites en la cantidad de paquetes que el coleccionista pueda comprar. La carga de datos
finaliza con un número de paquete igual a 0. Calcular e informar:
...
Teniendo en cuenta que cada paquete cuesta $500 y que cada figurita común se puede vender a $20 y
cada holograma a $50. Calcular el costo total de la colección y el costo total de una potencial venta
de figuritas no pegadas de la colección.

Aclaraciones:
Cuando se carga los datos de un paquete se debe solicitar la información de las cinco figuritas que
incluye el paquete.
El álbum tiene 50 figuritas en total pero los paquetes pueden traer de cada una la variante común y
...
Por ejemplo, si tengo la figurita #1 común y #1 holograma en mi colección, no la tengo repetida.
Sin embargo, si tres veces tengo la figura #1 holograma en mi colección entonces la tengo repetida DOS veces.

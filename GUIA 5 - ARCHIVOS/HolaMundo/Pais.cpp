...
Pais::Pais(const char* codigo, const char* codigo2, const char* nombre, const char* continente,
           float superficie, int poblacion, short independencia, float expectativaDeVida, int capital)
{
    setCodigo(codigo);
